...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmVuYXRvZmFnYWxkZSIsImEiOiJja3Jnajg4bWUybDlkMnBuamI4N3VveWxhIn0.g83JP3RDHV8zAOuhYIU0KQ';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logout');
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            uri = type === 'password' ? 'updateMyPassword' : 'updateMe';
            url = "http://127.0.0.1:3000/api/v1/users/".concat(uri);
            console.log("change current info: ".concat(url));
            _context.next = 6;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51JHvFAEIdBoWYQtNh2Ug7JNxe8ne4IfTdSlXx4mwM8r8w1uVTS5RZfDM1THjbc5oPZh7gLb6axq2L4b9Fa2638gF00Mwzs60zr');
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  console.log("booking id=> ".concat(tourId));
